...
public:
	...
	void Load(const char *name, std::string& utf8_value, const std::string& default_value="");
	...
	void Save(const char *name, const char *utf8_value);
	void Save(const char *name, const std::string& utf8_value);
