...
## インストール
https://github.com/hta393939/metaseqtry/releases/tag/0.9.1 ページから exportgpb.0.9.1.zip をダウンロードします。

メニューから「ヘルプ」→「プラグインについて」をクリックします。
「プラグインについて」ダイアログの「インストール」をクリックします。
さきほどダウンロードした exportgpb.0.9.1.zip ファイルを選択して
「開く」をクリックします。
