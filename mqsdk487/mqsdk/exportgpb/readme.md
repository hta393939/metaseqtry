...
## インストール
https://github.com/hta393939/metaseqtry/releases/tag/0.10.1 ページから exportgpb.0.10.1.zip をダウンロードします。

メニューから「ヘルプ」→「プラグインについて」をクリックします。
「プラグインについて」ダイアログの「インストール」をクリックします。
さきほどダウンロードした exportgpb.0.10.1.zip ファイルを選択して
「開く」をクリックします。
...
2024-12-30: ver.0.10.1 ボーン出力時に .hsp ファイルに回転と平行移動成分を書き出す。   
