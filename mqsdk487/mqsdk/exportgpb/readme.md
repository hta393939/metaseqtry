...
## インストール
https://github.com/hta393939/metaseqtry/releases/tag/0.13.1 ページから exportgpb.0.13.1.zip をダウンロードします。

メニューから「ヘルプ」→「プラグインについて」をクリックします。
「プラグインについて」ダイアログの「インストール」をクリックします。
さきほどダウンロードした exportgpb.0.13.1.zip ファイルを選択して
「開く」をクリックします。
...
2025-01-03: v0.13.1 .hsp ファイルでカーソルキーによるカメラ移動を追加した。   
 実装のヘッダファイルを分離。   
