...
public:
	...
	MString splittedString(wchar_t separator, size_t index) const;
	...
	static MString fromUInt64(__uint64 value, int radix = 10);
	...
	bool isMatch(const MString& filter) const;
